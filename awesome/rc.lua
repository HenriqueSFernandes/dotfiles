...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            weather_widget({
            api_key='<11de74703c1d08233a85e685fdaa1578',
            coordinates = {41.1776, -8.5867},
            }),
            --mykeyboardlayout,
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "l",
              function ()
                  awful.spawn.with_shell("lock") end,
    ...
    -- Media Control
    awful.key({}, "XF86AudioPlay", function () awful.spawn.with_shell("britl play-pause") end, {description = "Pause media", group = "custom"}),
    awful.key({}, "XF86AudioNext", function () awful.spawn.with_shell("playerctl next") end, {description= "Next media", group = "custom"}),
    awful.key({}, "XF86AudioPrev", function () awful.spawn.with_shell("playerctl previous") end, {description = "Previous media", group = "custom"}),
    -- Volume Control
...
--awful.spawn.with_shell("feh --bg-scale /home/ricky/Pictures/Wallpapers/wallhaven-jxd1x5.jpg")
awful.spawn.with_shell("~/.fehbg &")
awful.spawn.with_shell("unclutter")
awful.spawn.with_shell("polychromatic-cli -d keyboard -e Wave")
--awful.spawn.with_shell("nm-applet &")
awful.spawn.with_shell("xinput set-prop \"MSFT0002:00 04F3:31AD Touchpad\" \"libinput Tapping Enabled\" 1")
